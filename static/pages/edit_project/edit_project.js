...
// Tam sayfa yenilemede /edit_project/ID açıldıysa (dashboard ayrıca navigate ile tetikler)
...
if (editProjectForm) editProjectForm.addEventListener('submit', async (e) => {
    e.preventDefault();
